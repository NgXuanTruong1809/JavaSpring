                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">@XuanTruong</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h4 class="text-light mb-3">Tại sao mọi người lại mua sản phẩm của chúng tôi ?</h4>
                            <p class="mb-4">Chất lượng hàng đầu, giá cả hợp lý, uy tín.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author: Xuan Truong</p>
                            <p>Email: NgXuanTruong1809@gmail.com</p>
