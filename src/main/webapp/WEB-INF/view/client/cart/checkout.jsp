                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="mb-0 mt-4" data-cartDetail-id="${cartDetail.id}">
                                                    <fmt:formatNumber type="number"
                                                        value="${cartDetail.quantity * cartDetail.product.price}" /> đ
                                                    <c:set var="totalAmount"
                                                        value="${totalAmount + cartDetail.quantity * cartDetail.product.price}" />
                                                </p>
                                            </td>
                                            <td>
                            ...
                            <div class="mt-5 row g-4 justify-content-between">
                                <div class="col-12 col-md-6 my-auto">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="receiverPhone" type="text" class="form-control" required />
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-light rounded">
                                        ...
                                        <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                            ...
                                            <input type="text" name="totalAmount"
                                                data-cart-total-price="${totalAmount} " value="${totalAmount}"
                                                style="display: none;">
