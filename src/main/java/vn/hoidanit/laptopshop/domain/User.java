...
public class User implements Serializable {
    ...
    private static final long serialVersionUID = 1L; // implements Serializable and this row for save object to session
    ...
    // role ID
    @ManyToOne
    @JoinColumn(name = "role_id") // create role_id to join with id in role table
    private Role role;
