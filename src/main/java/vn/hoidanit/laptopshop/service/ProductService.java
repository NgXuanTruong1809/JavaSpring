...
public class ProductService {
    ...
    public Page<Product> getAllProductsSpecification(String name, Pageable pageable) {
    ...
    // case 6
    public Page<Product> getAllProductsSpecification(Pageable page, List<String> price) {
